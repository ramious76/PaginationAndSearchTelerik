...
namespace PaginationAndSearch.Server.Services
    ...
    public partial class AdventureWorksContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Contact>(entity =>
            {
                ...
                entity.HasComment("Names of each employee, customer contact, and vendor contact.");

                entity.HasIndex(e => e.Rowguid, "AK_Contact_rowguid")
                    .IsUnique();
            ...
            modelBuilder.Entity<ContactCreditCard>(entity =>
            {
                entity.HasKey(e => new { e.ContactId, e.CreditCardId })
                    .HasName("PK_ContactCreditCard_ContactID_CreditCardID");

                entity.ToTable("ContactCreditCard", "Sales");

                entity.HasComment("Cross-reference table mapping customers in the Contact table to their credit card information in the CreditCard table. ");
            ...
            modelBuilder.Entity<ContactType>(entity =>
            {
                ...
                entity.HasComment("Lookup table containing the types of contacts stored in Contact.");
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.HasComment("Current customer information. Also see the Individual and Store tables.");
            ...
            modelBuilder.Entity<Document>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.FileName, e.Revision }, "AK_Document_FileName_Revision")
                    .IsUnique();
            ...
            modelBuilder.Entity<EmployeeAddress>(entity =>
            {
                entity.HasKey(e => new { e.EmployeeId, e.AddressId })
                    .HasName("PK_EmployeeAddress_EmployeeID_AddressID");

                entity.ToTable("EmployeeAddress", "HumanResources");

                entity.HasComment("Cross-reference table mapping employees to their address(es).");

                entity.HasIndex(e => e.Rowguid, "AK_EmployeeAddress_rowguid")
                    .IsUnique();
            ...
            modelBuilder.Entity<EmployeeDepartmentHistory>(entity =>
            {
                entity.HasKey(e => new { e.EmployeeId, e.StartDate, e.DepartmentId, e.ShiftId })
                    .HasName("PK_EmployeeDepartmentHistory_EmployeeID_StartDate_DepartmentID");
            ...
            modelBuilder.Entity<Individual>(entity =>
            {
                entity.HasKey(e => e.CustomerId)
                    .HasName("PK_Individual_CustomerID");

                entity.ToTable("Individual", "Sales");

                entity.HasComment("Demographic data about customers that purchase Adventure Works products online.");
            ...
            modelBuilder.Entity<ProductDocument>(entity =>
            {
                entity.HasKey(e => new { e.ProductId, e.DocumentId })
                    .HasName("PK_ProductDocument_ProductID_DocumentID");
            ...
            modelBuilder.Entity<ProductVendor>(entity =>
            {
                entity.HasKey(e => new { e.ProductId, e.VendorId })
                    .HasName("PK_ProductVendor_ProductID_VendorID");
            ...
            modelBuilder.Entity<SalesPersonQuotaHistory>(entity =>
            {
                entity.HasKey(e => new { e.SalesPersonId, e.QuotaDate })
                    .HasName("PK_SalesPersonQuotaHistory_SalesPersonID_QuotaDate");
            ...
            modelBuilder.Entity<SalesTerritoryHistory>(entity =>
            {
                entity.HasKey(e => new { e.SalesPersonId, e.StartDate, e.TerritoryId })
                    .HasName("PK_SalesTerritoryHistory_SalesPersonID_StartDate_TerritoryID");
            ...
            modelBuilder.Entity<StoreContact>(entity =>
            {
                entity.HasKey(e => new { e.CustomerId, e.ContactId })
                    .HasName("PK_StoreContact_CustomerID_ContactID");

                entity.ToTable("StoreContact", "Sales");

                entity.HasComment("Cross-reference table mapping stores and their employees.");

                entity.HasIndex(e => e.Rowguid, "AK_StoreContact_rowguid")
                    .IsUnique();
            ...
            modelBuilder.Entity<VIndividualDemographic>(entity =>
            {
                ...
                entity.ToView("vIndividualDemographics", "Sales");

                entity.HasComment("Displays the content from each element in the xml column Demographics for each customer in the Sales.Individual table.");
            ...
            modelBuilder.Entity<VStoreWithDemographic>(entity =>
            {
                ...
                entity.HasComment("Stores (names and addresses) that sell Adventure Works Cycles products to consumers.");
            ...
            modelBuilder.Entity<VVendor>(entity =>
            {
                ...
                entity.ToView("vVendor", "Purchasing");

                entity.HasComment("Vendor (company) names and addresses and the names of vendor employees to contact.");
            ...
            modelBuilder.Entity<VendorAddress>(entity =>
            {
                entity.HasKey(e => new { e.VendorId, e.AddressId })
                    .HasName("PK_VendorAddress_VendorID_AddressID");

                entity.ToTable("VendorAddress", "Purchasing");

                entity.HasComment("Cross-reference mapping vendors and addresses.");
            ...
            modelBuilder.Entity<VendorContact>(entity =>
            {
                entity.HasKey(e => new { e.VendorId, e.ContactId })
                    .HasName("PK_VendorContact_VendorID_ContactID");

                entity.ToTable("VendorContact", "Purchasing");

                entity.HasComment("Cross-reference table mapping vendors and their employees.");
